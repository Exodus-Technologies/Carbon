...
3. Returns below for a user that provided a valid email but their password does not meet password requirements or criteria:
...
4. Returns below for a user is the server could not handle the request:
